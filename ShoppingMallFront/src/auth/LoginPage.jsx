...
const LoginPage = () => {
  ...
  const loginE = async () => {
    try {
      await loginMember(User.m_email, User.m_password); // 인증 성공 테스트
      navigate("/shop"); // ✅ 로그인 후 이동할 실제 경로
    } catch (err) {
  ...
  const loginG = () => {
    ...
    const googleClientId =
      "858945058074-7droigq2d1o18bh69su5q5frd9qff4m2.apps.googleusercontent.com";
